...
Hello there! This repository contains the code and presentation slides for "Choose Your Fighter: SpringAI vs LangChain4J", a talk that I gave at DevNexus 2026. The repository will also contain the link to the recording of the talk itself.
